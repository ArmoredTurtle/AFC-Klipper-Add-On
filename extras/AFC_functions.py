...
class afcFunction:
    ...
    def write_auto_variables(self, section_name, value_name, value):
        """
        Function writes variables to a seperate file defined by `auto_var_file. 
    ...
    def gcode_get_value( self, gcmd, get_attr, variable, variable_name, section_name, key_name=None, cast_to_bool=False ):
        ...
        as defualt value. If user passed in a new value then config file is updated with new value. 
        Do not call this function if a macro variable is required.
